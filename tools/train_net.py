...
register_soba_instances("soba_cast_shadow_train_full", {}, "../datasets/SOBA_v2/annotations/SOBA_train_relation_v2.json", "../datasets/SOBA_v2")
register_soba_instances("soba_cast_shadow_val_full",{},"../datasets/SOBA_v2/annotations/SOBA_val_v2.json","../datasets/SOBA_v2")
register_soba_instances("soba_cast_shadow_val_challenge",{},"../datasets/SOBA_v2/annotations/SOBA_challenge_v2.json","../datasets/SOBA_v2")
